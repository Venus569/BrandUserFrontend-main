        ...
        <div class="container-fluid container-custom-three">
          ...
          >
                  ...
                  <div class="sigma-header-nav-inner">
                    <nav>
                      <ul class="sigma-main-menu">
                        ...
                        <li class="menu-item">
                          <Link to="/creatorpersonalprofile"> welcome back {userdeta.name} </Link>
                        </li>
            ...
            <div class="menu-right-buttons">
              ...
              <div class="login-btn">
                <Link to="/creatorpersonalprofile"
        ...
        <div class="container-fluid container-custom-three">
          <div class="d-flex align-items-center justify-content-between">
            ...
            <form class="sigma_search-form">
              <input type="text" placeholder="Search Collabs" />
              <span class="icon">
