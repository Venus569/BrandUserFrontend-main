    ...
    flimzyFans = {
        ...
        topbartoggle() {
            $(".topbar-toggler").on('click', function() {
                $(".sigma-menu-btn-2").toggleClass("active");
        ...
        roomSlider() {
            var sliderImg = $('.story-slider-one'),
                sliderContent = $('.cpt-content-slider'),
        ...
        //===== 05. Latest Post Slider
        BureauPostlider() {
            var tslider = $('.influencerbanner-post-slider');
            var arrows = $('.influencerbanner-post-arrow');
            tslider.slick({
                slidesToShow: 4,
                slidesToScroll: 1,
                fade: false,
        ...
        wideBureauPostlider() {
            var tslider = $('.wide-influencerbanner-post-slider');
            tslider.slick({
                slidesToShow: 4,
                slidesToScroll: 1,
                fade: false,
        ...
        //===== 06. Feature Jewelry Slider
        featureJewelry() {
            var fslider = $('.feature-stories-slider');
            var arrows = $('.feature-cpt-arrow');
            fslider.slick({
                slidesToShow: 3,
                slidesToScroll: 1,
                fade: false,
        ...
        //===== influencerbanner Detail Slider
        Bureauslider() {
        ...
        roomSliderTwo() {
            var sliderTwo = $('.story-slider-two');
            sliderTwo.slick({
                slidesToShow: 1,
                slidesToScroll: 1,
                fade: false,
